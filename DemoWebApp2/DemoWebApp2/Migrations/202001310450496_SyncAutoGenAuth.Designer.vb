...
Namespace Migrations
    ...
    Public NotInheritable Partial Class SyncAutoGenAuth
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(SyncAutoGenAuth))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202001310450496_SyncAutoGenAuth"
            End Get
        End Property
